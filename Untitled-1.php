...
<head>
    ...
    <link rel="stylesheet" href="css1/swiper-bundle.min.css">
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-5PQP0DC3MK"></script>
    <script type='text/javascript' src='//remembercompetitioninexplicable.com/01/38/bb/0138bbba13aa275b8bae55779d96a3df.js'></script>
    <script type='text/javascript' src='//remembercompetitioninexplicable.com/74/79/0a/74790a1bebb4326b4fc8aa1e2ab2d2c8.js'></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5PQP0DC3MK');
</script>
...
<script type='text/javascript' src='//pl16984470.trustedcpmrevenue.com/74/79/0a/74790a1bebb4326b4fc8aa1e2ab2d2c8.js'></script>
            ...
            $run = mysqli_query($con, $query);
                ...
                if ($run) {
                    while ($row = mysqli_fetch_assoc($run)) {
                        ...
                        <script async="async" data-cfasync="false" src="//remembercompetitioninexplicable.com/a71a66083eda395342d3898bc855acc4/invoke.js"></script>
<div id="container-a71a66083eda395342d3898bc855acc4"></div>
                        <!-- =========movie-details -->
                        ...
                        <section class="screenshots">
                            ...
                            <div class="screen-s-container">
                                <img src="thumb/<?php echo $row['ss1']; ?>" alt="<? echo $row ['mv_name'];?>">
