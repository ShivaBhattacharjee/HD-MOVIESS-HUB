...
<body>
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
    <div class="head">
        <h1 style="text-align: center; color:red;">Genre List of  H.D Movies Hub</h1>
    </div>
    <br>
    <a href="addgenre.php" class="btn btn-outline-primary">Add a genre +</a>
    <hr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="deletegenre.php?id=<?php echo $row['id'];?>" class="btn btn-outline-danger">Delete</a></td>
    </tr>
<?php
}
      }
