...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            ?>
                        <div class="jumbotron">
                            <img src="../thumb/<?php echo $row['img'];?> " alt="" class="img">
                            <h1 class="display-7"><?php echo $row['mv_name'];?></h1>
                            <small>Date:-</small>
                            <p class="lead"><?php echo $row['date'];?></p>
                            <small>Language:-</small>
                            <p class="lead"><?php echo $row['lang'];?></p>
                            <small>Director:-</small>
                            <p class="lead"><?php echo $row['director'];?></p>
                            <hr class="my-1">
                            <small>Description:-</small>
                            <h3><?php echo $row['mv_desc'];?>.</h3>
                            <br>
                            <h4>Tags:-</h4>
                            <small><?php echo $row['mv_tag'];?></small>
                            <br>
                            <br>
                            <p class="lead">
                                <a class="btn btn-info btn-lg" href="<?php echo $row['link1'];?>" role="button">480p</a>
                                <a class="btn btn-info btn-lg" href="<?php echo $row['link2'];?>" role="button">720p</a>
                                <a class="btn btn-info btn-lg" href="<?php echo $row['link3'];?>" role="button">1080p</a>
                            </p>
                            <p class="lead">
                                <h1>Functions</h1>
                                <a class="btn btn-outline-warning btn-lg" href="edit.php?id=<?php echo $row['id'];?>" role="button">Edit </a> &nbsp;&nbsp;
                                <a class="btn btn-outline-danger btn-lg" href="deletemovie.php?id=<?php echo $row['id'];?>" role="button">Delete</a>
                            </p>
                        </div>
            <?php
