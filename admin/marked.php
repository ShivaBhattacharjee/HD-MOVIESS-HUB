...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <br><br><br>
                <h2 style="color:red;">Marked Messages and Requests</h2>
                <br><br><br>
                    ...
                    <tbody>
                        <tr>
                            ...
                            ?>
                                    ...
                                    <td><a href="deleteread.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                        <?php
                            $i++;
                                }
