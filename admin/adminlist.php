...
<body>
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h1 style="text-align: center; color:red; margin-top:40px;margin-bottom:40px;">Admin List of HD Movies Hub</h1>
      <hr>
      <div class="container">
          ...
          ?>
              <tbody>
                <tr>
                  ...
                  <td scope="row"><b><?php echo $row['uname']; ?></b></td>
                  <td> <small>PASSWORD ENCRYPTED</small></td>
                  <td><a class="btn btn-danger" href="deleteadmin.php? id=<?php echo $row['id'] ?>">Delete Admin</a>
                </tr>
            <?php
              $i++;
            }
